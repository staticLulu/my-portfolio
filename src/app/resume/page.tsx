...
const Resume = () => {
  ...
  const mySoftSkills = [
    { id: 1, title: 'Research', },
    { id: 2, title: 'flexibility', },
    { id: 3, title: 'Work in team', },
    { id: 4, title: 'Impeccable Communication', },
    { id: 5, title: 'High Commitment', },
    { id: 6, title: 'Respect rules of company', },
    { id: 7, title: 'Time Management', },
  ];

  return (
    <Box className='xs:p-5 md:0'>
      <SectionComponent title="Resume">
        <Box className="grid md:grid-cols-2 gap-4 mt-4">
          ...
          <Box className="grid gap-5">
            ...
            <Box className="grid xl:grid-cols-2 gap-2.5">
