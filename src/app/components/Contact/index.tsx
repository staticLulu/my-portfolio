...
const Contact = () => {
  ...
  return (
    <Box className='grid gap-4 p-5 xs:mb-5 md:0' id='contact'>
      <SectionComponent title='Contact'>
        <Box className='grid gap-4 lg:grid-cols-2'>
          <SectionCard
            title='Phone:'
            icon={
              <MdOutlinePhoneInTalk className='w-[20px] h-[20px] text-[#A084DC]' />
            }
          >
          ...
          <SectionCard
            title='Email:'
            icon={
              <MdOutlineAttachEmail className='w-[20px] h-[20px] text-[#A084DC]' />
            }
          >
            <Typography className='font-medium dark:text-slate-400 xs:text-sm sm:text-base'>
              dang.dangmakara@gmail.com
            </Typography>
          </SectionCard>
        </Box>
      </SectionComponent>
      ...
      >
        <Typography className='dark:text-slate-200'>
          I am always open to discussing new project, opportunities in tech
          ...
          <FormControl className='w-full grid gap-2.5'>
            <Box>
              ...
              <TextField
                ...
                fullWidth
              />
              <FormHelperText className='text-red-400 m-0'>
                {errors.name?.message}
              </FormHelperText>
            </Box>
            <Box>
  ...
  return (
    ...
    >
      <Box className='flex items-center gap-2'>
        {icon}
        <Typography className='font-semibold text-[18px] dark:text-slate-200'>
          {title}
        </Typography>
      </Box>
      <Box className='pl-7'>{children}</Box>
    </Box>
  );
};
